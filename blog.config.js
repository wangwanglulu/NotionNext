...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        ...
        process.env.NOTION_PAGE_ID || '4be20bb03f3b4545be78067debd56e1b',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个商学院教师, Hi，也是一个普通干饭人,欢迎来到我的博客🎉',


  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lu Wang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个运营管理教师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wangwanglulu.com', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/wangwanglulu', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.wangwanglulu.com/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
